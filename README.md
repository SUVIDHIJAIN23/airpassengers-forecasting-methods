...
airpassengers-forecasting-methods/
├── README.md
├── requirements.txt
├── forecasting_methods.ipynb       # Main analysis notebook
...
- Box, G.E.P. & Jenkins, G.M. (1970). *Time Series Analysis: Forecasting and Control*. Originator of the AirPassengers dataset.
- Hyndman, R.J. & Athanasopoulos, G. (2025). *Forecasting: Principles and Practice, the Pythonic Way*. [otexts.com/fpppy](https://otexts.com/fpppy/)
- Nixtla documentation: [statsforecast](https://nixtlaverse.nixtla.io/statsforecast), [mlforecast](https://nixtlaverse.nixtla.io/mlforecast)
- M5 Forecasting Competition (Makridakis et al., 2022) — referenced methodology for LightGBM target transforms
